  ...
  return (
    <footer className="bg-charcoal text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        {/* Founder strip */}
        <div className="flex items-center gap-4 mb-10 pb-8 border-b border-gray-700/60">
          <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-gray-600 flex-shrink-0">
            <Image
              src="/founder.png"
          ...
          <div>
            <p className="text-white font-semibold text-sm font-[family-name:var(--font-display)]">{siteConfig.founder.name}</p>
            <p className="text-gray-400 text-xs">Founder & Instructor</p>
          </div>
          <a
