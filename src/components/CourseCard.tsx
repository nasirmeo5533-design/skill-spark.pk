...
const categoryGraphics: Record<string, React.ReactNode> = {
  "Generative AI": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="160" textAnchor="middle" fill="#FAF8F5" fontSize="14" fontFamily="Nunito, sans-serif" fontWeight="600" opacity="0.4">AI</text>
    </svg>
  ),
  "AI Automation": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="170" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">AUTOMATE</text>
    </svg>
  ),
  "Prompt Engineering": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="158" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">PROMPT</text>
    </svg>
  ),
  "Meta Ads": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="170" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">GROWTH</text>
    </svg>
  ),
  Shopify: (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="170" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">STORE</text>
    </svg>
  ),
  "Content Creation": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      <rect width="320" height="180" fill="#1C1C1E" />
      <rect x="50" y="35" width="80" height="55" rx="6" fill="#FF7A1A" opacity="0.3" />
      <rect x="140" y="25" width="80" height="55" rx="6" fill="#FFC93C" opacity="0.25" />
      <rect x="90" y="75" width="80" height="55" rx="6" fill="#FF7A1A" opacity="0.2" />
      <text x="160" y="158" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">CREATE</text>
    </svg>
  ),
  "Digital Marketing": (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="158" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">REACH</text>
    </svg>
  ),
  Freelancing: (
    <svg viewBox="0 0 320 180" className="w-full h-full">
      ...
      <text x="160" y="158" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">EARN</text>
    </svg>
  ),
};
...
const fallbackGraphic = (
  <svg viewBox="0 0 320 180" className="w-full h-full">
    ...
    <text x="160" y="158" textAnchor="middle" fill="#FAF8F5" fontSize="11" fontFamily="Nunito, sans-serif" fontWeight="500" opacity="0.3">LEARN</text>
  </svg>
);
...
export default function CourseCard({ course }: { course: Course }) {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    cardRef.current.style.boxShadow = `0 20px 60px rgba(255, 122, 26, 0.15), 0 0 30px rgba(255, 122, 26, 0.1)`;
  };
  ...
  return (
    <div
      ...
      className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 group border border-warm-gray/40 cursor-pointer card-shine"
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden">
        ...
        {/* Price Tag */}
        <div className="absolute top-3 right-3 bg-primary/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm font-semibold font-[family-name:var(--font-display)] shadow-lg animate-glow">
      ...
      <div className="p-5">
        {/* Category Badge */}
        <span className="inline-block bg-primary/10 text-primary text-xs font-semibold px-3 py-1 rounded-full mb-3 uppercase tracking-wider group-hover:bg-primary group-hover:text-white transition-colors duration-300">
          {course.category}
        </span>
        ...
        <Link
          ...
          className="block w-full bg-charcoal text-white text-center py-3 rounded-lg font-semibold hover:bg-primary transition-all duration-300 font-[family-name:var(--font-display)] text-sm group-hover:shadow-lg group-hover:shadow-primary/30 animate-btn-shimmer-hover"
        >
          View Course
        </Link>
      </div>
